...
"|    <|     |   <   |    < |   _||    |     /  |   __>
"|  0  |  |  |\    \ |     \|  |  |    |   | \  |     \
"|____/|__|__|  \___||___|__|__|  |____|___|___\|_____/
"_________________________________________________________
"  
"
"
...
hi! Comment ctermfg=238 guifg=#6b7089
hi! Constant ctermfg=210 guifg=#a093c7
...
hi! WarningMsg ctermbg=0 ctermfg=164 guibg=#161821 guifg=#e27878
hi! EndOfBuffer ctermbg=0 ctermfg=237 guibg=#161821 guifg=#242940
hi! NonText ctermbg=0 ctermfg=237 guibg=#161821 guifg=#242940
hi! SpecialKey ctermbg=0 ctermfg=237 guibg=#161821 guifg=#242940
hi! Folded ctermbg=0 ctermfg=245 guibg=#1e2132 guifg=#686f9a
hi! FoldColumn ctermbg=235 ctermfg=239 guibg=#1e2132 guifg=#444b71
hi! Function ctermfg=88 guifg=#84a0c6
hi! Identifier cterm=NONE ctermfg=196 guifg=#89b8c2
hi! Include ctermfg=88 guifg=#84a0c6
hi! LineNr ctermbg=0 ctermfg=88 guibg=#1e2132 guifg=#444b71
hi! MatchParen ctermbg=88 ctermfg=0 guibg=#3e445e guifg=#ffffff
hi! MoreMsg ctermfg=150 guifg=#b4be82
hi! Normal ctermbg=0 ctermfg=255 guibg=#161821 guifg=#c6c8d1
hi! Operator ctermfg=250 guifg=#84a0c6
...
hi! PreProc ctermfg=250 guifg=#b4be82
hi! Question ctermfg=150 guifg=#b4be82
hi! QuickFixLine ctermbg=237 ctermfg=252 guibg=#272c42 guifg=#c6c8d1
hi! Search ctermbg=88 ctermfg=0 guibg=#e4aa80 guifg=#392313
hi! SignColumn ctermbg=0 ctermfg=239 guibg=#1e2132 guifg=#444b71
hi! Special ctermfg=1 guifg=#b4be82
hi! SpellBad ctermbg=237 ctermfg=255 gui=undercurl guisp=#e27878
...
hi! Statement ctermfg=250 gui=NONE guifg=#84a0c6
hi! StatusLine cterm=reverse ctermbg=0 ctermfg=1 gui=reverse guibg=#17171b guifg=#818596 term=reverse
hi! StatusLineTerm cterm=reverse ctermbg=0 ctermfg=245 gui=reverse guibg=#17171b guifg=#818596 term=reverse
...
hi! TabLineSel cterm=NONE ctermbg=0 ctermfg=196 gui=NONE guibg=#161821 guifg=#9a9ca5
hi! Title ctermfg=196 gui=NONE guifg=#e2a478
hi! Todo ctermbg=164 ctermfg=0 guibg=#45493e guifg=#b4be82
hi! Type ctermfg=1 gui=NONE guifg=#84a0c6
hi! Underlined cterm=underline ctermfg=81 gui=underline guifg=#84a0c6 term=underline
hi! VertSplit cterm=NONE ctermbg=196 ctermfg=196 gui=NONE guibg=#0f1117 guifg=#0f1117
