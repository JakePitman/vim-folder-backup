...
let g:colors_name = 'midnightsun'


hi! ColorColumn cterm=NONE ctermbg=232 guibg=#1e2132
hi! CursorColumn cterm=NONE ctermbg=232 guibg=#1e2132
hi! CursorLine cterm=NONE ctermbg=235 guibg=#1e2132
hi! Comment ctermfg=24 guifg=#6b7089
hi! Constant ctermfg=6 guifg=#a093c7
hi! Cursor ctermbg=226 ctermfg=232 guibg=#c6c8d1 guifg=#161821
hi! CursorLineNr ctermbg=232 ctermfg=184 guibg=#2a3158 guifg=#cdd1e6
...
hi! Directory ctermfg=67 guifg=#89b8c2
...
hi! Function ctermfg=123 guifg=#84a0c6
hi! Identifier cterm=NONE ctermfg=14 guifg=#89b8c2
hi! Include ctermfg=81 guifg=#84a0c6
hi! LineNr ctermbg=232 ctermfg=67 guibg=#1e2132 guifg=#444b71
hi! MatchParen ctermbg=184 ctermfg=236 guibg=#3e445e guifg=#ffffff
hi! MoreMsg ctermfg=150 guifg=#b4be82
hi! Normal ctermbg=232 ctermfg=255 guibg=#161821 guifg=#c6c8d1
hi! Operator ctermfg=81 guifg=#84a0c6
hi! Pmenu ctermbg=232 ctermfg=251 guibg=#3d425b guifg=#c6c8d1
hi! PmenuSbar ctermbg=236 guibg=#3d425b
hi! PmenuSel ctermbg=226 ctermfg=232 guibg=#5b6389 guifg=#eff0f4
...
hi! Search ctermbg=67 ctermfg=0 guibg=#e4aa80 guifg=#392313
hi! SignColumn ctermbg=232 ctermfg=239 guibg=#1e2132 guifg=#444b71
hi! Special ctermfg=33 guifg=#b4be82
"hi! SpellBad ctermbg=24 ctermfg=255 gui=undercurl guisp=#e27878
hi! SpellBad ctermbg=236 ctermfg=255 gui=undercurl guisp=#e27878
...
hi! Statement ctermfg=81 gui=NONE guifg=#84a0c6
...
hi! Structure ctermfg=81 guifg=#84a0c6
...
hi! TabLineSel cterm=NONE ctermbg=232 ctermfg=81 gui=NONE guibg=#161821 guifg=#9a9ca5
hi! Title ctermfg=81 gui=NONE guifg=#e2a478
hi! Todo ctermbg=186 ctermfg=0 guibg=#45493e guifg=#b4be82
hi! Type ctermfg=39 gui=NONE guifg=#84a0c6
hi! Underlined cterm=underline ctermfg=81 gui=underline guifg=#84a0c6 term=underline
hi! VertSplit cterm=NONE ctermbg=186 ctermfg=186 gui=NONE guibg=#0f1117 guifg=#0f1117
hi! Visual ctermbg=226 ctermfg=232 guibg=#272c42
hi! Number ctermbg=232 ctermfg=75 guibg=#272c42
...
hi! SyntasticStyleWarningSign ctermbg=232 ctermfg=216 guibg=#1e2132 guifg=#e2a478
hi! SyntasticWarningSign ctermbg=232 ctermfg=216 guibg=#1e2132 guifg=#e2a478
